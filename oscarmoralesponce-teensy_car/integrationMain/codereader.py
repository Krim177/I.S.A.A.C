    ...
    def run(self):
        ...
        while True:
            ...
            if self.shareObjects.code > 0:
                #print('[AC, t] trying to find marker with id {0}'.format(self.shareObjects.code))
                ...
                if ids.get() is not None and self.shareObjects.code in ids.get().flatten():
                    ...
                    print("Codereader - distance:", z, " offset: ", x)
                    ...
                    if debugging:
                            ...
                            save_fname = './live_images/' + str(self.shareObjects.offset) + 'x_' + str(self.shareObjects.distance) + 'z.jpg'
